...
#ifndef MENUBAR_RUNCAT_SWIFT_H
#define MENUBAR_RUNCAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Menubar_RunCat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14Menubar_RunCat11AppDelegate")
...
- (void)receiveSleep:(NSNotification * _Nonnull)notification;
- (void)receiveWakeUp:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC14Menubar_RunCat15TestAppDelegate")
